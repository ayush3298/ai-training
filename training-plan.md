...
5. ⬜ **Security, Privacy & Governance** — highest risk reduction; the *injection* + *PII-redaction* reflexes are already grafted into [Chapter 3](chapters/03-prompt-engineering.md)/[Chapter 4](chapters/04-rag.md), keep the full chapter before [Chapter 8](chapters/08-deployment.md).
